...
void curarTodos(Inimigo*vector, int n, int cura){
    for(int i = 0; i < n; i++){
        Inimigo *ini = (vector + i);
...
Inimigo
*encontrarInimigoMaisFraco(Inimigo *vetor, int n){
...
int main(void) {
    ...
    while (!WindowShouldClose()) {
        ...
        BeginDrawing();
            ...
            DrawText("C cura todos os inimigos vivos",10,35,18, DARKGRAY);
